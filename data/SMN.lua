...
function user_setup()
	...
	EspiritusSMS = {name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}}
	EspiritusMAB = {name="Espiritus", augments={'MP+50','Pet: "Mag.Atk.Bns."+20','Pet: Mag. Acc.+20',}}

	Grioavolr = { name="Grioavolr", augments={'Blood Pact Dmg.+8','Pet: VIT+4','Pet: Mag. Acc.+25','Pet: "Mag.Atk.Bns."+22','DMG:+16',}}
...
function init_gear_sets()
	...
	-- Precast Sets -----------------------------------------------------------
	---------------------------------------------------------------------------
	-- Bloodpac Ability Delay ( Max Cap: 30 I - 15s, II - 15s, III - 10s ) ----
	---------------------------------------------------------------------------
	sets.precast.BloodPactRage = {
		main=EspiritusSMS,				  --00s/02s
		sub="Vox Grip",
		ammo="Sancus Sachet +1",		--00s/07s
		head="Beckoner's Horn +1",
		neck="Caller's Pendant",
		ear1="Andoaa Earring",
		ear2="Evans Earring",			  --02s
		ring1="Evoker's Ring",
		ring2="Fervor Ring",
		body="Beckoner's Doublet +1",
		hands="Glyphic Bracers",		--05s
		back="Conveyance Cape",			--00s/01s
		legs="Beckoner's Spats +1",
		feet="Glyphic Pigaches"			--05s
	------------------------------ Total: 10s/10s/10s---------------------------
	}

	sets.precast.BloodPactWard = sets.precast.BloodPactRage
	...
	sets.precast.JA['Elemental Siphon'] = {main=EspiritusSMS, sub="Vox Grip", ammo="Esper Stone +1",
		head="Beckoner's Horn +1",neck="Caller's Pendant",ear1="Andoaa Earring", ear2="Moonshade Earring",
		body="Beckoner's Doublet +1",hands="Lamassu Mitts +1",ring1="Evoker's Ring",ring2="Fervor Ring",
		back="Conveyance Cape", legs="Beckoner's Spats +1",feet="Beckoner's Pigaches +1"}
...
-------------------------------------------------------------------------------
	...
	---------------------------------------------------------------------------
	sets.midcast.Pet.BloodPactWard = {main=EspiritusSMS,sub="Elan Strap",ammo="Sancus Sachet +1",
		head="Apogee Crown +1",neck="Caller's Pendant", ear1="Gifted Earring",
		body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
		back="Conveyance Cape", waist="Diabolos's Rope",legs="Marduk's Shalwar +1"}

	sets.midcast.Pet.DebuffBloodPactWard = {main=EspiritusSMS, sub="Elan Strap",ammo="Sancus Sachet +1",
		head="Apogee Crown +1",neck="Caller's Pendant",
		body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
		back="Conveyance Cape",waist="Diabolos's Rope",legs="Marduk's Shalwar +1"}
	...
	sets.HP=set_combine(sets.midcast.Pet.PhysicalBloodPactRage, {body="Anhur Robe", feet="Herald Gaiters"})
----sets.
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
	...
	-- 	main="Gridarvor", sub="Elan Strap",
	-- 	head="Apogee Crown +1",
	-- 	hands="Apogee Mitts +1",
	-- 	legs="Apogee Slacks +1", ring2="Fervor Ring",})
...
-------------------------------------------------------------------------------
	...
	sets.idle = {main="Gridarvor",sub="Vox Grip",ammo="Sancus Sachet +1",
		head="Beckoner's Horn +1",neck="Caller's Pendant",ear1="Evans Earring",ear2="Moonshade Earring",
		body="Witching Robe",hands="Inyanga Dastanas +2",ring1="Evoker's Ring",ring2="Inyanga Ring",
		back="Campestres's Cape",waist="Fucho-no-Obi",legs="Assiduity Pants +1",feet="Inyanga Crackows +2"
	}
	---------------------------------------------------------------------------
	...
	sets.idle.Spirit = {main="Gridarvor",sub="Achaq Grip",ammo="Sancus Sachet +1",
		...
		back="",waist="Fucho-no-Obi",legs="Summoner's Spats",feet="Herald's Gaiters"}
	...
	sets.perp.Alexander = set_combine( sets.idle, { main="" })
	...
	---------------------------------------------------------------------------
	sets.defense.MDT = { 
		head="Hagondes Hat",neck="Loricate Collar",ear1="Gifted Earring",ear2="Loquacious Earring",
