...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Thew Bomblet",
        head="Yaoyotl Helm",neck=gear.default.weaponskill_neck,ear1="Brutal Earring",ear2="Moonshade Earring",
        body="Phorcys Korazin",hands="Otronif Gloves",ring1="Rajas Ring",ring2="Spiral Ring",
        back="Atheling Mantle",waist=gear.default.weaponskill_waist,legs="Karieyh Brayettes +1",feet="Karieyh Sollerets +1"}
    sets.precast.WS.Acc = set_combine(sets.precast.WS, {back="Letalis Mantle"})

    -- Specific weaponskill sets.  Uses the base set if an appropriate WSMod version isn't found.
    sets.precast.WS['Tachi: Fudo']     = set_combine(sets.precast.WS, {neck=""})
    sets.precast.WS['Tachi: Fudo'].Acc = set_combine(sets.precast.WS.Acc, {neck=""})
    sets.precast.WS['Tachi: Fudo'].Mod = set_combine(sets.precast.WS['Tachi: Fudo'], {waist=""})

    sets.precast.WS['Tachi: Shoha']     = set_combine(sets.precast.WS, {neck=""})
    sets.precast.WS['Tachi: Shoha'].Acc = set_combine(sets.precast.WS.Acc, {neck=""})
    sets.precast.WS['Tachi: Shoha'].Mod = set_combine(sets.precast.WS['Tachi: Shoha'], {waist=""})
    ...
    sets.precast.WS['Tachi: Rana'].Mod = set_combine(sets.precast.WS['Tachi: Rana'], {waist=""})
    ...
    sets.idle.Town = {main="Tsurumaru", sub="Pole Grip",ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Anguinus Belt",legs="Phorcys Dirs",feet="Danzo Sune-ate"}
    ...
    sets.engaged = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Anguinus Belt",legs="Unkai Haidate +2",feet="Otronif Boots +1"}
