...
function init_gear_sets()
    ...
    sets.engaged = {ammo="Ginsen",
        head="Herculean Helm",neck="Asperity Necklace",ear1="Steelflash Earring",ear2="Bladeborn Earring",
    ...
    sets.engaged.Acc = {ammo="Yamarang",
		head="Meghanada Visor +1", neck="Iqabi Necklace", ear1="Dudgeon Earring", ear2="Heartseeker Earring",
		body="Meghanada Cuirie +2",	hands="Meghanada Gloves +2", ring1="Ramuh Ring +1",	ring2="Rajas Ring",
		back="Senuna's Mantle", waist="Anguinus Belt", legs="Meghanada Chausses +1", feet="Meghanada Jambeaux +2"}
    ...
    sets.engaged.MaxHaste = {ammo="Charis Feather",
        ...
        body="Qaaxo Harness",hands="Maxixi Bangles",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Windbuffet Belt",legs="",feet="Manibozho Boots"}
