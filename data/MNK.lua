...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist=gear.ElementalBelt,legs="Quiahuiz Trousers",feet="Manibozho Boots"}
    sets.precast.WSAcc = {ammo="Ginsen",body="Manibozho Jerkin",back="Letalis Mantle",feet="Qaaxo Leggings"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Uk'uxkaj Cap",neck="Loricate Collar",
    ...
    sets.engaged.PDT = {ammo="Thew Bomblet",
        head="Uk'uxkaj Cap",neck="Loricate Collar",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Otronif Harness +1",hands="Otronif Gloves",ring1=LeftDarkRing,ring2=RightDarkRing,
        back="Anchoret's Mantle",waist="Windbuffet Belt +1",legs="Hesychast's Hose +1",feet="Otronif Boots +1"}
    ...
    sets.engaged.Acc.PDT = {ammo="Ginsen",
        head="Whirlpool Mask",neck="Loricate Collar",ear1="Bladeborn Earring",ear2="Steelflash Earring",
    ...
    sets.engaged.Counter = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Windbuffet Belt +1",legs="Anchorite's Hose",feet="Otronif Boots +1"}
