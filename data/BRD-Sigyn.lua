...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Felibre's Dague",
    sub="Genbu's Shield",
    range="Gjallarhorn",
    head="Fili Calot +1",
    body="Yigit Gomlek",
    hands="Schellenband",
    legs={ name="Gendewitha Spats", augments={'Phys. dmg. taken -1%','Song spellcasting time -2%',}},
    feet={ name="Bihu Slippers", augments={'Enhances "Nightingale" effect',}},
    neck="Aoidos' Matinee",
    waist="Aoidos' Belt",
    left_ear="Aoidos' Earring",
    right_ear="Minstrel's Earring",
    left_ring="Carb. Ring",
    ...
    sets.midcast.FastRecast = {main={ name="Kali", augments={'MP+60','Mag. Acc.+20','"Refresh"+1',}},
    sub="Elegant Shield",
    range="Gjallarhorn",
    head="Fili Calot +1",
    ...
    sets.midcast['Magic Finale'] = {main={ name="Malevolence", augments={'INT+10','Mag. Acc.+10','"Mag.Atk.Bns."+10','"Fast Cast"+5',}},
    sub="Elegant Shield",
    range="Gjallarhorn",
    ...
    sets.midcast.SongDebuff = set_combine(sets.midcast.resistantsongdebuff)

    -- For song defbuffs (accuracy primary, duration secondary)
    sets.midcast.ResistantSongDebuff = {main={ name="Malevolence", augments={'INT+10','Mag. Acc.+10','"Mag.Atk.Bns."+10','"Fast Cast"+5',}},
    sub="Elegant Shield",
    range="Gjallarhorn",
    head="Inyanga Tiara +1",
    body={ name="Bihu Jstcorps +1", augments={'Enhances "Troubadour" effect',}},
    ...
    sets.midcast.DaurdablaDummy = {main="Vanir knife",range=info.ExtraSongInstrument,
        head="Bihu roundlet +1",neck="Twilight Torque",ear1="Aoidos' Earring",ear2="Minstrel's Earring",
        body="Brioso Justaucorps +1",hands="Bihu cuffs +1",ring1="Carb. Ring",ring2="Carb. Ring",
        back="Cheviot Cape",waist="Goading Belt",legs="Bihu cannions +1",feet="Fili cothurnes"}

    -- Other general spells and classes.
    sets.midcast.Cure = {main="Serenity",sub="Niobid strap",
        head="Kaykaus mitra",hands="Telchine Gloves",back="Solemnity Cape"
        legs="Chironic hose",feet="Kaykaus boots"}
